...
if __name__ == '__main__':
    # Set FLATQUANT_SKIP_DEPLOY_KERNELS=1 to install the core package only,
    # skipping the deploy._CUDA inference kernels (which require cmake + the
    # cutlass submodule). Useful when you only need quantization/eval (main.py).
    skip_deploy_kernels = os.environ.get('FLATQUANT_SKIP_DEPLOY_KERNELS', '0') == '1'

    if skip_deploy_kernels:
        setup(
            name='flatquant',
